...
ROOT_DIR = environ.Path(__file__) - 3  # (deleteme/config/settings/base.py - 3 = deleteme/)
APPS_DIR = ROOT_DIR.path('deleteme')
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['deleteme.taskapp.celery.CeleryAppConfig']
if USE_TZ:
